...
## Windows: open the dashboard (easy path)

1. Install [Python 3.11+](https://www.python.org/downloads/) — tick **Add python.exe to PATH**.
2. Download ZIP from GitHub (Code → Download ZIP) and unzip.
3. Double-click **`start.bat`** in the project folder.
4. Browser opens **http://localhost:8501** — charts + table.

Full click-by-click guide (Russian): **[HOWTO-WINDOWS.md](HOWTO-WINDOWS.md)**
